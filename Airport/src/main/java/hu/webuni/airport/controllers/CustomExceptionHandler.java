...
public class CustomExceptionHandler {
  ...
  public ResponseEntity<MyError> handleNonUniqueIata(NonUniqueException e, WebRequest request){
  ...
  public ResponseEntity<MyError> handleValidationError(MethodArgumentNotValidException e, WebRequest request){
    log.warn(e.getMessage(),e);
